#!/usr/bin/env bash
# Safely start/stop the experimental GLM-5.3 EXL3 K4 vLLM profile with rollback.
set -euo pipefail
...
TARGET="glm53-flash-exl3-k4-vllm-sm120-v1"
RUN="$SCRIPT_DIR/run-glm53-flash-exl3-k4-vllm-sm120-v1.sh"
MODE="${1:-status}"
