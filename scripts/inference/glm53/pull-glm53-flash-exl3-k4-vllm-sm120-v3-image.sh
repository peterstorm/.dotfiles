#!/usr/bin/env bash
# Pull and prove the v84 TP2/EP2/DCP2 DFlash2 + vision SM120 image.
set -euo pipefail
...
IDENTITY_FILE="${IDENTITY_FILE:-$HOME/.local/state/glm53/exl3-k4-vllm-sm120-v3-image.identity}"
...
print("GLM-5.3 v84 DFlash2 + multimodal capability probe: PASS")
PY
