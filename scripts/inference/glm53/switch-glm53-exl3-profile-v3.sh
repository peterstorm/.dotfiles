#!/usr/bin/env bash
# Safely start/stop the multimodal GLM-5.3 EXL3 K4 v84 profile with rollback.
set -euo pipefail
...
TARGET="glm53-flash-exl3-k4-vllm-sm120-v3"
RUN="$SCRIPT_DIR/run-glm53-flash-exl3-k4-vllm-sm120-v3.sh"
MODE="${1:-status}"
