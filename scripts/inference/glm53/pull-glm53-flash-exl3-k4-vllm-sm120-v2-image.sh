#!/usr/bin/env bash
# Pull and prove the upstream TP2/MTP3 v37 GLM-5.3 EXL3 K4 SM120 artifact.
set -euo pipefail

IMAGE="verdictai/glm53-flash-exl3-k4@sha256:bb0f2c524f3d55c03df25f62b4c7353fcce6a77468876028da2d6e58530c5f24"
EXPECTED_ID="sha256:8cdac4aa483d6be7bd1a18961e57dbeddefc102f9f786689eece8b8a7ed419aa"
IDENTITY_FILE="${IDENTITY_FILE:-$HOME/.local/state/glm53/exl3-k4-vllm-sm120-v2-image.identity}"
UPSTREAM_RUNTIME_REV="b526998ef7644d90569866ef1df82999e26dcbfc"
UPSTREAM_COMPOSE_SHA256="e36d2cbcbe235587fb77160bfa39c54b7c260fa361bba67e294a5eff4890a7e3"
...
jq -e '.[0] |
  ...
  .Config.Labels["local-inference.glm53.gdn-dcp-mtp-fix"] == "local-token-split-zero-row-and-kpool-live-write-count" and
...
image_index=sha256:711df22b7ccb121fe7838f9dfa23b0ec8235280534be3a08fd55ed58d61d1989
platform=linux/amd64
upstream_runtime_revision=$UPSTREAM_RUNTIME_REV
upstream_compose_sha256=$UPSTREAM_COMPOSE_SHA256
