...
- If PR already exists:
  ...
  - Review current PR body with `gh pr view --json body`
  - Update PR description to reflect new changes using `gh pr edit --body`
...
Step 3: PR
  ...
  Action: Pushed 2 new commits, updated PR description
