...
hardener_contains 'from .prompt_enhance_routes import register_prompt_enhance_routes'
hardener_contains 'register_prompt_enhance_routes(routes, _register_route)'
