...
contains "$SKILL" 'MiniMaxH3ReferenceToVideo'
contains "$SKILL" 'captured-awaiting-user-review'
contains "$WORKFLOW" 'reference → mechanism reconstruction → original remix'
contains "$WORKFLOW" 'minimax-h3-blender-ref2va-development'
contains "$WORKFLOW" '15-second Turbo and PDD profiles are duration-qualification candidates'
contains "$WORKFLOW" 'VIDEO-CARRIER-CONTRACT.md'
...
printf 'PASS: Blender MCP is pinned, loopback-scoped, telemetry-off, Pi-discoverable, and H3-handoff aware\n'
