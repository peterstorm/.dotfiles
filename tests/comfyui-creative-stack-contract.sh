...
contains "$MODULE" '--replace-warn '\''krea2_turbo_fp8_scaled.safetensors'\'' '\''krea2_turbo_int8_convrot.safetensors'\'''
...
contains "$MODULE" 'rm -rf "$ep29_dir" "$ep30_dir" "$elite_dir"'
...
contains "$RUNBOOK" '54 curated official workflows'
