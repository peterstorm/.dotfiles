...
contains "$WORKFLOW_BUILDER" 'identity_nodes[232]["widgets_values"][0] = 0'
contains "$WORKFLOW_BUILDER" 'slider_state["sliders"][0]["value"] = 0'
...
contains "$WORKFLOW_BUILDER" 'def empty_image_node('
contains "$WORKFLOW_BUILDER" '"widgets_values": [1536, 768, 1, 7829367]'
contains "$WORKFLOW_BUILDER" 'add_link(graph, 300, 0, 228, 1, "IMAGE")'
contains "$WORKFLOW_BUILDER" 'add_link(graph, 301, 0, 232, 1, "LATENT")'
contains "$WORKFLOW_BUILDER" 'add_link(graph, 300, 0, 232, 5, "IMAGE")'
contains "$WORKFLOW_BUILDER" 'add_link(graph, 164, 0, 503, 0, "IMAGE")'
contains "$WORKFLOW_BUILDER" 'the uploaded reference must never enter spatial conditioning'
...
contains "$RUNBOOK" '**85 user workflows:**'
