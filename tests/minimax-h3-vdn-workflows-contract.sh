...
contains '${comfyPythonEnv}/bin/python tests/test_vdn_math.py'
contains '${comfyPythonEnv}/bin/python tests/test_window_dispatch.py'
contains '${comfyPythonEnv}/bin/python tests/test_optimizations.py'
