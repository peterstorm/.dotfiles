...
### Preset E — "Clean Craft" (Warm Trade)
- **Identity:** A master craftsperson's workshop — honest materials, quiet confidence, tools laid out with precision.
- **Palette:** Navy `#1B2A4A` (Primary), Amber `#D4922A` (Accent), Warm White `#F7F5F0` (Background), Iron `#2C2C2C` (Text/Dark)
- **Typography:** Headings: "DM Sans" (tight tracking). Drama: "Lora" Italic. Data: `"Source Code Pro"`.
- **Image Mood:** workshop tools, copper fittings, clean workspaces, hands at work, warm workshop lighting.
- **Hero line pattern:** "[Trade noun], built" (Bold Sans) / "[Quality word]." (Massive Serif Italic)

### Preset F — "Soft Studio" (Modern Warmth)
- **Identity:** A Scandinavian design studio — light-filled, tactile, effortlessly refined.
- **Palette:** Sage `#7A8B6F` (Primary), Blush `#C8847A` (Accent), Linen `#FAF6F1` (Background), Espresso `#2A2320` (Text/Dark)
- **Typography:** Headings: "Nunito Sans" (tight tracking). Drama: "Crimson Pro" Italic. Data: `"Inconsolata"`.
- **Image Mood:** natural light, salon interiors, soft textures, botanicals, warm tones.
- **Hero line pattern:** "[Experience noun] that" (Bold Sans) / "[Feeling word]." (Massive Serif Italic)

### Preset G — "Bright Practice" (Clinical Warmth)
- **Identity:** A boutique medical practice — spotless, modern, reassuringly human.
- **Palette:** Teal `#1A6B5A` (Primary), Coral `#E07A5F` (Accent), Cloud `#F8F9FA` (Background), Slate `#2D3436` (Text/Dark)
- **Typography:** Headings: "Manrope" (tight tracking). Drama: "Source Serif 4" Italic. Data: `"Roboto Mono"`.
- **Image Mood:** clean interiors, bright treatment rooms, friendly professionals, white surfaces, modern equipment.
- **Hero line pattern:** "[Care noun] rooted in" (Bold Sans) / "[Trust word]." (Massive Serif Italic)
