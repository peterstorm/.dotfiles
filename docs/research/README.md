...
|---|---|---|
| 2026-09-13 | [`2026-09-13-glm53-v12-source-port-research.md`](2026-09-13-glm53-v12-source-port-research.md) — consolidated GLM-5.3 EXL3 K4 v12 port ledger: prior Spark TP2 source findings, R2 fixed-context/LMCache update, proposed narrow composition, and qualification gates. **Implemented 2026-09-14 as v12** (`glm53-v12-upstream-core-port/` + contract test, PASS) — deployment receipt: `benchmarks/vllm-tps/2026-09-14-glm53-v12-deployment-receipt.md` | [`glm53-v12-2026-09-13-evidence/`](glm53-v12-2026-09-13-evidence/) (source lock, registry/artifact/qualification records, upstream page, and R1→R2 recipe diff) |
