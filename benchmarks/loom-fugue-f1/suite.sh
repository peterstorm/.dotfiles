...
# Every local arm now lives in the shared model-ab catalog, so this suite no
# longer carries a private arm record. The extra-arm hook existed only for the
# retired glm-v8 profile.
