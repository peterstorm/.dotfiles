...
1. **code-reviewer** - Project guidelines compliance, bugs, architecture
...
6. **architecture-agent** *(auto-triggered for large PRs)* - FC/IS adherence, coupling, testability, service layer design, brand duplication, I/O boundary placement
   ...
   - Prompt must include: file list, diff stats, architecture principles from project guidelines
