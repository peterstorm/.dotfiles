...
Invoke the /opencode-spec-check skill for wave-gate spec alignment verification.

## YOUR CAPABILITY

Full tool access to execute the /opencode-spec-check skill properly.

**PRIMARY** action: Call the Skill tool to invoke /opencode-spec-check.
...
```
Skill(skill: "opencode-spec-check")
```
...
After /opencode-spec-check completes, format output as:
