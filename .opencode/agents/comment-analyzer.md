...
For this codebase, pay attention to:
- Comments describing Either-based error handling flow
- Documentation of sealed type hierarchies and their purposes
- Invariant documentation in record constructors
- Business rule explanations that should match domain language
