...
- **architecture-agent** = review existing code (reactive, via `/review-pr`)
...
5. **Security implications** - flag if design introduces trust boundaries, auth decisions, or injection surfaces
