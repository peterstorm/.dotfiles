 ...
 */
export async function verifyNewTests(
  context: TaskCompletionContext,
  taskGraph: TaskGraph,
  stateManager: StateManager,
  diffContent?: string
): Promise<NewTestEvidence | null> {
  // Extract task ID
 ...
 */
export function detectNewTests(diffContent: string): NewTestEvidence {
  if (!diffContent) {
 ...
 */
function isReviewAgent(agentType?: string): boolean {
 ...
 */
export function analyzeFilesForTests(
