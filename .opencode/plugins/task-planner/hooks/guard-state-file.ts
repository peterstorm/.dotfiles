...
export function guardStateFile(
  ...
  const hasWriteOperation = BASH_WRITE_PATTERNS.some((pattern) =>
 ...
 */
function findProtectedFileInCommand(command: string): string | null {
 ...
 */
export function getProtectedPatterns(): readonly RegExp[] {
