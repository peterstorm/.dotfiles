...
import { validateTaskExecution, checkWaveOrder, checkDependencies, checkReviewGate, isTaskReady, getReadyTasks, getRemainingTasks, } from "./validate-task-execution.js";
// ============================================================================
// Test Fixtures
// ============================================================================
...
describe("validateTaskExecution", () => {
    ...
    describe("when not a Task tool", () => {
        it("allows non-Task tools", () => {
            ...
            const result = validateTaskExecution(input, taskGraph);
            expect(result.allowed).toBe(true);
        });
    });
    describe("when task not in graph", () => {
        it("allows ad-hoc tasks", () => {
            ...
            const result = validateTaskExecution(createTaskInput("T99"), taskGraph);
            expect(result.allowed).toBe(true);
    ...
    describe("wave order validation", () => {
        it("allows task in current wave", () => {
            ...
            const result = validateTaskExecution(createTaskInput("T1"), taskGraph);
            expect(result.allowed).toBe(true);
        });
        ...
        it("blocks task from future wave", () => {
            ...
            expect(() => validateTaskExecution(createTaskInput("T1"), taskGraph)).toThrow(/wave 3.*wave 1/i);
        });
    });
    describe("dependency validation", () => {
        ...
        it("allows task with completed dependencies", () => {
            ...
            const result = validateTaskExecution(createTaskInput("T2"), taskGraph);
            expect(result.allowed).toBe(true);
        });
        ...
        it("blocks task with pending dependencies", () => {
            ...
            expect(() => validateTaskExecution(createTaskInput("T2"), taskGraph)).toThrow(/dependencies not met/i);
        });
    ...
    describe("review gate validation", () => {
        ...
        it("blocks task when previous wave gate not passed", () => {
            ...
            expect(() => validateTaskExecution(createTaskInput("T1"), taskGraph)).toThrow(/wave 1 review gate/i);
        });
...
//# sourceMappingURL=validate-task-execution.test.js.map